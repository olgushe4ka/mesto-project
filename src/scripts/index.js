...
const popupWithFormProfile = new PopupWithForm(popupProfile, { formData: () => {} });
...
const popupWithFormAvatar = new PopupWithForm(popupAvatarEdit, { formData: () => {} });
...
// const photoElement = document.querySelector('.photo-grid__photo');
// const form__field_title = document.querySelector('.edit-form__field_title');
// const form__field_link = document.querySelector('.edit-form__field_link');
// const photo__photo = document.querySelector('.popup-photo__photo');
// const photo__title = document.querySelector('.popup-photo__title');

// photoElement.addEventListener('click', popupWithImage.open(form__field_title, form__field_link, photo__photo, photo__title));
